    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-white to-yellow-100 flex items-center justify-center p-3 md:p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-6 md:mb-8">
          <div className="bg-yellow-400 p-3 md:p-4 rounded-2xl inline-block mb-3 md:mb-4 shadow-lg">
            <Calendar className="h-10 w-10 md:h-12 md:w-12 text-yellow-900" />
          </div>
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Digital Calendar</h1>
          <p className="text-sm md:text-base text-gray-600">Your premium calendar and diary application</p>
        </div>

        {/* Features Grid */}
        <div className="grid grid-cols-2 gap-3 md:gap-4 mb-6 md:mb-8">
          <div className="bg-white p-3 md:p-4 rounded-xl shadow-sm border border-gray-100">
            <Sync className="h-5 w-5 md:h-6 md:w-6 text-yellow-600 mb-2" />
            <h3 className="font-semibold text-gray-900 text-xs md:text-sm">Google Sync</h3>
            <p className="text-xs text-gray-600">Sync with Google Calendar</p>
          </div>
          <div className="bg-white p-3 md:p-4 rounded-xl shadow-sm border border-gray-100">
            <Calendar className="h-5 w-5 md:h-6 md:w-6 text-blue-600 mb-2" />
            <h3 className="font-semibold text-gray-900 text-xs md:text-sm">Event Management</h3>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-6 md:p-8">
          <div className="text-center mb-4 md:mb-6">
            <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Welcome Back</h2>
          ...
          <button
            onClick={onSignIn}
            disabled={isLoading}
            className="w-full bg-white border-2 border-gray-300 hover:border-gray-400 text-gray-700 font-semibold py-3 md:py-4 px-4 md:px-6 rounded-xl transition-all duration-200 flex items-center justify-center space-x-2 md:space-x-3 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed text-sm md:text-base"
          >
            {isLoading ? (
          ...
          <div className="mt-4 md:mt-6 text-center">
            <p className="text-xs text-gray-500">
              ...
              {error && (
                <span className="block mt-1 md:mt-2 text-yellow-600">
